# ETTrace capture and analysis workflow

Use this workflow to capture a focused, symbolicated ETTrace profile from an iOS simulator app. Pair it with `../../ios-debugger-agent/SKILL.md` when the task also needs simulator build, install, launch, UI driving, logs, or screenshots.
